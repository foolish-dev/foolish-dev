...
- **[FoolDev/Thanatos-27B](https://huggingface.co/FoolDev/Thanatos-27B)** — Thanatos-27B (Qwen3.6 27B dense), Claude Fable 5 reasoning teacher, Q4_K_M ~17 GB and Q3_K_S ~12 GB. Same bridge-file setup, plus an `examples/` + `scripts/` tooling layer (smoke + bench + bridge-sync regression guards).
