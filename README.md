...
- **[FoolDev/Janus-35B](https://huggingface.co/FoolDev/Janus-35B)** — Janus-35B (Qwen3.6 35B/3B MoE), Q4_K_M ~19 GB. Tools / thinking capabilities wired via root-level `template` / `system` / `params` files.
